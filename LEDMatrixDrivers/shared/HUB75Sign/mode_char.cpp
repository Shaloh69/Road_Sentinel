...
void render() {
  ...
  display::drawAt(s, x, y, HC_WHITE, size);
  ...
  display::gfx()->drawPixel(0, 0, HC_YELLOW);
  display::gfx()->drawPixel(CANVAS_W - 1, 0, HC_YELLOW);
  display::gfx()->drawPixel(0, CANVAS_H - 1, HC_YELLOW);
  display::gfx()->drawPixel(CANVAS_W - 1, CANVAS_H - 1, HC_YELLOW);
}
