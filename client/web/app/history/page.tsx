            ...
            <CardBody className="p-0">
              ...
              <div className="p-4 bg-white/10 backdrop-blur-sm border-t border-white/10">
                <div className="flex items-center gap-4">
                  <Button className="bg-white text-[#1B1931]" size="sm">
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                      viewBox="0 0 20 20"
        ...
        <CardBody className="p-4">
          <div className="space-y-3">
            {recordings.map((rec) => (
              <div
                key={rec.id}
                className="flex items-center justify-between p-4 bg-white/10 backdrop-blur-sm rounded-lg hover:bg-white/15 transition-colors cursor-pointer border border-white/10"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-white font-semibold">
                      {rec.camera} - {rec.timestamp}
                    </p>
                    <p className="text-white/70 text-sm">
                      Duration: {rec.duration} | Vehicles: {rec.vehicles} |
                      Incidents: {rec.incidents}
                    </p>
                  </div>
                </div>
                <Button
                  className="bg-white text-[#1B1931] font-semibold hover:bg-white/90"
                  size="sm"
                >
                  Play
                </Button>
